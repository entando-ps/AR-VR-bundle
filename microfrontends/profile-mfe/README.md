...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/accesscode/formWidget/>):
   1. Run `npm i`
...
- **accesscode.form.createError** (fired when an error occurs during accesscode creation)
- **accesscode.form.create** (fired when the accesscode is successfully created)
- **accesscode.form.updateError** (fired when an error occurs during accesscode update)
- **accesscode.form.update** (fired when the accesscode is successfully updated)
